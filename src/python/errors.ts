...
class BaseRequestException(Exception):
    ...
    def __init__(
        ...
        *args: Any,
        ...
        if request_url is None and response is not None and getattr(response, "request", None) is not None:
            request_url = str(response.request.url)
        if request_method is None and response is not None and getattr(response, "request", None) is not None:
        ...
        if response_json is not None:
            ...
            if error_description is None:
                error_description = cast(Optional[str], response_json.get("error_description"))
            if param is None:
...
class EmailVerificationRequiredException(AuthorizationException):
    ...
    def __init__(self, *args: Any, email_verification_id: Optional[str] = None, **kwargs: Any) -> None:
        ...
        if email_verification_id is None and response_json is not None:
            email_verification_id = cast(Optional[str], response_json.get("email_verification_id"))
        super().__init__(*args, **kwargs)
